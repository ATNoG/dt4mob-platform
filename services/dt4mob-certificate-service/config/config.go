...
type Config struct {
	...
	PermittedRoles []string `env:"PERMITTED_ROLES" envSeparator:"," envDefault:"certificate-issuer"`

	DefaultCertificateTTL time.Duration `env:"DEFAULT_CERTIFICATE_TTL" envDefault:"720h"` // Default: 30 days
	MaxCertificateTTL     time.Duration `env:"MAX_CERTIFICATE_TTL" envDefault:"2160h"`    // Default: 90 days
}
